...
const Footer = () => {
  return (
    <div className="bg-[#000] text-white">
      <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-lightBlue  py-6">
        <h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5">
          <span className="text-yellow font-semibold">Subscribe</span> us to get
          news, <br />
          events and offers
        </h1>
        <div>
          ...
          />
          <button className="bg-yellow  hover:bg-yellow/90 duration-300 px-5 py-2.5 font-semibold rounded-md text-black md:w-auto w-full">
            Submit
          </button>
        </div>
      </div>
